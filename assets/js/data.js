...
const TCG_SEED_PRODUCTS = [
  ...
  { id: 2, code: 'TCG002', name: 'Donquixote Doflamingo', description: 'Edición: Super Pre-Release Starter Deck 3: The Seven Warlords of the Sea', price: 7500, originalPrice: 10000, onSale: false, game: 'One Piece', stock: 5, criticalStock: 2, category: 'Cartas individuales', image: 'assets/img/doffy.png' },
  ...
  { id: 6, code: 'TCG006', name: 'Protectores de mazos: Magic: The Gathering (24)', description: 'Pack de protectores para mantener las cartas en buen estado.', price: 6990, originalPrice: 6990, onSale: false, game: 'Magic', stock: 30, criticalStock: 5, category: 'Accesorios', image: 'assets/img/Magic.png' },
  ...
  { id: 10, code: 'TCG0010', name: 'Pokemon TCG - League Battle Deck Mega Lucario ex - Inglés', description: 'En esta caja encontrarás: 1 mazo de 60 cartas listo para jugar, 6 contadores de daño en forma de dado, 1 dado para lanzamiento de moneda, 2 marcadores de condición en forma de moneda, 1 portamazo, 1 hoja con estrategias, 1 carta con código para jugar con este mazo en línea.', price: 37990, originalPrice: 42990, onSale: false, game: 'One Piece', stock: 6, criticalStock: 2, category: 'Cajas', image: 'assets/img/Lucario.webp' },
  { id: 11, code: 'TCG008', name: 'Jace, the Mind Sculptor', description: '“Jace, the Mind Sculptor” es una carta de tipo Legendary Planeswalker — Jace de la edición Double Masters (2XM)', price: 17000, originalPrice: 20500, onSale: true, game: 'Magic', stock: 1, criticalStock: 1, category: 'Cartas individuales', image: 'assets/img/Jace.webp' },
  { id: 12, code: 'TCG0012', name: 'Protectores de mazos: VOL. 1 KAIDO', description: 'Pack de protectores para mantener las cartas en buen estado.', price: 6000, originalPrice: 10000, onSale: false, game: 'One Piece', stock: 30, criticalStock: 5, category: 'Accesorios', image: 'assets/img/kaido.webp' }
];
